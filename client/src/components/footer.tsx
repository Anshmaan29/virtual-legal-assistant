    ...
    <footer className="bg-neutral-800 text-neutral-300 py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            <div className="flex items-center space-x-2">
              ...
              <h2 className="text-xl font-bold text-white">DriveWise AI</h2>
            </div>
            <p className="mt-2 text-sm max-w-md">
              Your AI assistant for all questions related to motor vehicle rules, regulations, and safe driving practices.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-1 text-sm">
                <li><Link href="/handbook"><a className="hover:text-white">Rule Handbook</a></Link></li>
                <li><Link href="/tests"><a className="hover:text-white">Practice Tests</a></Link></li>
                <li><Link href="/scenarios"><a className="hover:text-white">Traffic Scenarios</a></Link></li>
                <li><Link href="/tips"><a className="hover:text-white">Safety Tips</a></Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-1 text-sm">
                ...
                <li><Link href="/team"><a className="hover:text-white">Our Team</a></Link></li>
            ...
            <div>
              ...
              <ul className="space-y-1 text-sm">
                ...
                <li><Link href="/data"><a className="hover:text-white">Data Use</a></Link></li>
        ...
        <div className="mt-8 pt-6 border-t border-neutral-700 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">© {new Date().getFullYear()} DriveWise AI. All rights reserved.</p>
